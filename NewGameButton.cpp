...
void NewGameButton::newGame() {
    ...
    //getting input for length, range determined by what fits in game window 
    std::cout << "Please enter the desired length of the board (anywhere between 5 to 26 tiles): " << std::endl;
    std::cin >> length;
    ...
    while (length > 26 | length < 5 | std::cin.fail() | std::cin.peek() == '.') {
        ...
        //reprompts user
        std::cout << "Please enter an integer (whole number) length greater than 5 and less than 26: " << std::endl;
        std::cin >> length;
    };

    //getting input for width
    std::cout << "Please enter the desired width of the board (anywhere between 5 to 26 tiles): " << std::endl;
    std::cin >> width;
    ...
    while (width > 26 | width < 5 | std::cin.fail() | std::cin.peek() == '.') {
        ...
        std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
        //reprompts user
        std::cout << "Please enter an integer (whole number) width greater than 5 and less than 26: " << std::endl;
        std::cin >> width;
    };
    
    //getting input for mines, must be between 10% and 30% as this is the standard ratio of mine tiles to non-mine tiles 
    std::cout << "Please enter the desired number of mines (from " << floor(length * width * 0.1) << " to " << floor(length * width * 0.3) << "): " << std::endl;
    std::cin >> numberMines;
    ...
    while (numberMines > floor(length * width * 0.3) | numberMines < floor(length * width * 0.1) | std::cin.fail() | std::cin.peek() == '.') {
        ...
        //reprompts user
        std::cout << "Please enter an integer (whole number) number of mines from " << floor(length * width * 0.1) << " to " << floor(length * width * 0.3) << " tiles: " << std::endl;
        std::cin >> numberMines;
    };
