...
class TimerTest {
    ...
    void testStartTimer() {
        ...
        std::cout << "Timer state before startTimer(): " << beforeTest1 << std::endl; 
    ...
    void testStopTimer() {
        ...
        std::cout << "Timer state before startTimer(): " << beforeTimerStart << std::endl; 

        //start timer 
        test1.startTimer();

        bool afterTimerStart = test1.getStarted();
        std::cout << "Timer state after startTimer(): " << afterTimerStart << std::endl; 
    ...
    void testTimerMax() {
        std::cout << "\ntestTimerMax(): (Testing that timer will stop at maximum)" << std::endl;
        //creating game so functions can be run
        Minesweeper game(100, "Timer test");
    ...
    void testDraw() {
        std::cout << "\ntestDraw(): Refer to game window to see if test works" << std::endl;
        //creating game so functions can be run
        Minesweeper game(100, "Timer test");
